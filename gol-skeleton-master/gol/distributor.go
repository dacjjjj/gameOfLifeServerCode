...
func distributor(p Params, c distributorChannels) {
	...
	//erver := flag.String("server", "ip-3-82-94-167.ec2.internal.us-east-1b.compute.internal:8080", "IP:port for the AWS master") //change the ip to amazon
	//flag.Parse()
	client, _ := rpc.Dial("tcp", "ec2-54-205-96-33.compute-1.amazonaws.com:8030")
	defer client.Close()
